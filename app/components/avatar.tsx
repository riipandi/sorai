...
export const avatarStyles = tv({
  base: 'bg-avatar text-avatar-foreground relative flex items-center justify-center rounded-full font-semibold select-none',
  slots: {
    image: 'size-full rounded-full',
    fallback: 'flex size-full items-center justify-center rounded-full',
    fallbackInitial: 'flex size-full items-center justify-center rounded-full text-xl',
