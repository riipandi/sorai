...
export function Sidebar({
  ...
  className,
  ...props
}: React.ComponentProps<'aside'> & VariantProps<typeof sidebarStyles>) {
  return (
    <aside data-slot='sidebar' className={clx(sidebarStyles({ size, className }))} {...props} />
  )
}

export function SidebarHeader({ className, children, ...props }: React.ComponentProps<'header'>) {
  return (
    <header data-slot='sidebar-header' {...props} className={clx(className)}>
      {children}
    </header>
  )
}
...
export function SidebarFooter({ className, children, ...props }: React.ComponentProps<'footer'>) {
  return (
    <footer data-slot='sidebar-footer' className={clx('mt-auto', className)} {...props}>
      {children}
    </footer>
  )
}
...
export function SidebarItem({ className, children }: React.ComponentProps<'li'>) {
  return (
    <li
      ...
      className={clx(
        'group/sidebar-item',
        'relative flex **:data-[slot=sidebar-submenu]:w-auto',
        className
      )}
    >
      {children}
...
export const sidebarItemActionStyles = cva(
...
export function SidebarGroup({ className, children, ...props }: React.ComponentProps<'section'>) {
  return (
    <section
      ...
      className={clx('flex flex-wrap gap-0.5 *:data-[slot=sidebar-list]:p-0', className)}
      {...props}
    >
      {children}
    </section>
...
export function SidebarSubmenu({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      {...props}
      className={clx('border-border w-full border-l py-0.5', className)}
    />
  )
}
