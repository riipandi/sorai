...
const previewCardVariants = tv({
  slots: {
    positioner: [],
    popup: [
      'text-popover-foreground flex flex-col items-start gap-1',
      'bg-popover ring-popover-border shadow-popover origin-(--transform-origin) rounded-md ring',
...
export function PreviewCardPopup({
  ...
  const styles = previewCardVariants()
  return (
