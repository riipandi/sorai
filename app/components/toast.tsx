...
export const toastVariants = tv({
  slots: {
    ...
    root: [
      ...
      'h-auto min-h-fit',
      'border-toast-border bg-toast rounded-md border p-1 shadow-lg select-none',
    ...
    anchoredRoot: [
      ...
      'bg-toast border-toast-border rounded border shadow transition-[transform,scale,opacity]',
    ...
    arrow: 'fill-toast text-toast-border',
  ...
  variants: {
    position: {
      'top-left': {
        ...
        viewportPosition: 'start-3 top-3 flex-col-reverse',
        rootPosition: 'top-0 left-0 origin-top after:start-0 after:top-full'
      },
      'top-center': {
        viewportPosition: 'start-1/2 top-3 -translate-x-1/2 flex-col-reverse',
        rootPosition:
          'top-0 left-1/2 origin-top -translate-x-1/2 after:start-0 after:top-full after:translate-x-1/2'
      },
      'top-right': {
        viewportPosition: 'end-3 top-3 flex-col-reverse',
        rootPosition: 'top-0 right-0 origin-top after:start-0 after:top-full'
      },
      'bottom-left': {
        // flex-col: first toast stays at bottom, new ones added above
        viewportPosition: 'start-3 bottom-3 flex-col',
        rootPosition: 'bottom-0 left-0 origin-bottom after:start-0 after:top-full'
      },
      'bottom-center': {
        viewportPosition: 'start-1/2 bottom-3 -translate-x-1/2 flex-col',
        rootPosition:
          'bottom-0 left-1/2 origin-bottom -translate-x-1/2 after:start-0 after:top-full after:translate-x-1/2'
      },
      'bottom-right': {
        viewportPosition: 'end-3 bottom-3 flex-col',
        rootPosition: 'right-0 bottom-0 origin-bottom after:start-0 after:top-full'
      }
    },
    type: {
      success: {
        iconWrapper: '*:[svg]:fill-success/20 *:[svg]:stroke-success'
      },
      info: {
        iconWrapper: '*:[svg]:fill-info/20 *:[svg]:stroke-info'
      },
      warning: {
        iconWrapper: '*:[svg]:fill-warning/20 *:[svg]:stroke-warning'
      },
      error: {
        iconWrapper: '*:[svg]:fill-danger/20 *:[svg]:stroke-danger'
      }
    }
  },
  defaultVariants: {
  ...
  return (
    <>
      {Object.entries(toastsByPosition).map(([toastPosition, positionToasts]) => {
        ...
        const positionStyles = toastVariants({ position: toastPosition as ToastPosition })
    ...
    >
      ...
      >
        ...
        <BaseToast.Action
          ...
          className={clx(
            styles.action(),
            buttonStyles({ variant: 'tertiary', size: 'xs' }),
