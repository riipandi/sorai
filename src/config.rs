...
impl Config {
    ...
    pub fn display_debug_table(&self) {
        ...
        config_items.push(ConfigItem {
            ...
            value: self.logging.rotation.clone(),
        });
        ...
        config_items.push(ConfigItem {
            ...
            value: self.cors.enabled.to_string(),
        });
        config_items.push(ConfigItem {
            section: "CORS".to_string(),
            key: "Allow Origins".to_string(),
            value: self.cors.allow_origins.join(", "),
        });
        config_items.push(ConfigItem {
            section: "CORS".to_string(),
            key: "Allow Methods".to_string(),
            value: self.cors.allow_methods.join(", "),
        });
        config_items.push(ConfigItem {
            section: "CORS".to_string(),
            key: "Allow Headers".to_string(),
            value: self.cors.allow_headers.join(", "),
        });
        config_items.push(ConfigItem {
            section: "CORS".to_string(),
            key: "Allow Credentials".to_string(),
            value: self.cors.allow_credentials.to_string(),
        });
        config_items.push(ConfigItem {
            section: "CORS".to_string(),
            key: "Max Age".to_string(),
            value: format!("{}s", self.cors.max_age),
        });
